...
function love.update(dt)
    ...
    if difficulty == 1 then
        player2Speed = PADDLE_SPEED / 2
    else
        player2Speed = 3 * PADDLE_SPEED / 4
    end

    if gameState == 'play' then
        if ball.dx > 0 and ball.y < player2.y then
            player2.dy = -player2Speed
...
function love.keypressed(key)
    ...
    elseif key == '1' and gameState == 'selectDifficulty' then
        difficulty = 1
        gameState = 'serve'
    elseif key == '2' and gameState == 'selectDifficulty' then
        difficulty = 2
        gameState = 'serve'
    end
end
...
function love.draw()
    ...
    elseif gameState == 'selectDifficulty' then
        love.graphics.setFont(smallFont)
        love.graphics.printf('Select 1 for Easy or 2 for Hard!', 0, 10, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'play' then
